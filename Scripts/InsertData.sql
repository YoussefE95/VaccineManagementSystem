insert into Vaccines (Name, DosesRequired, DaysBetween, TotalDoses)
	Values('Pfizer/BioNTech', 2, 21, 10000);
insert into Vaccines (Name, DosesRequired, DaysBetween, TotalDoses)
	Values('Johnson & Johnson', 1, null, 5000);
insert into Vaccines (Name, DosesRequired, DaysBetween, TotalDoses)
	Values('Moderna', 2, 21, 0);
